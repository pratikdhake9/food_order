...
import com.example.food_order.service.RestaurantServiceImpl;
...
public class AdminRestaurantController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Restaurant> updateRestaurant(@RequestBody CreateRestaurantRequest req, @RequestHeader("Authorization") String jwt,Long id) throws Exception{
        User user=userService.findUserByJwtToken(jwt);
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<MessageResponse> deleteRestaurant(@RequestHeader("Authorization") String jwt,Long id) throws Exception{
        User user=userService.findUserByJwtToken(jwt);
    ...
    public ResponseEntity<Restaurant> updateRestaurantStatus(@RequestHeader("Authorization") String jwt,Long id) throws Exception{
        User user=userService.findUserByJwtToken(jwt);
        Restaurant restaurant= restaurantService.updateRestauranntStatus(id);
